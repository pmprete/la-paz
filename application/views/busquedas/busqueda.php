    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-inline" role="form" method="post" action="<?php echo site_url("busqueda/buscar")?>">
                    ...
                    <div class="form-group col-md-2">
                        <div class="input-group ">
                            ...
                            <input type="text" id="periodo_desde" name="periodo_desde" class="form-control datepicker" data-date-format="dd-mm-yyyy" value="<?php echo set_value('periodo_desde'); ?>">
                        </div>
                    </div>
                    <div class="form-group col-md-2">
                        <div class="input-group ">
                            ...
                            <input type="text" id="periodo_hasta" name="periodo_hasta" class="form-control datepicker" data-date-format="dd-mm-yyyy" value="<?php echo set_value('periodo_hasta'); ?>">
                        </div>
                    </div>
